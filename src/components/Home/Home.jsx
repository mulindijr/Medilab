      ...
      <div className='hero-bg'>
        ...
        <div className='hero-cards-container'>
          <div className='why-medilab'>
            ...
            <NavLink to="/"><button>Learn More<MdKeyboardArrowRight className='arrow-right' /></button></NavLink>
          </div>
          <div className='hero-cards'>
            <div className='hero-cards-icons'><MdHealthAndSafety /></div>
            <h3>Mission</h3>
            <p>At Medilab, our mission is to provide accessible, high-quality healthcare services to our community. We are committed to delivering compassionate care, utilizing innovative technologies, and fostering a culture of continuous improvement.</p>
          </div>
          <div className='hero-cards'>
            <div className='hero-cards-icons'><MdHealthAndSafety /></div>
            <h3>Vision</h3>
            <p>Our vision at Medilab is to be a leader in healthcare excellence, recognized for our unwavering commitment to patient-centered care, clinical innovation, and community engagement.</p>
          </div>
          <div className='hero-cards'>
            <div className='hero-cards-icons'><MdHealthAndSafety /></div>
            <h3>Motto</h3>
